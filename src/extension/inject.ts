...
bk_global.appendChild(document.createTextNode(\`
    ...
    ${!under ? "" :
    `body .split-view-view:nth-child(3) :not(.sticky-widget, .action-item) > *:not([role="tooltip"], .monaco-button, .context-view, .select-box-dropdown-list-container, .monaco-count-badge, .badge-content, .label), body > div {
