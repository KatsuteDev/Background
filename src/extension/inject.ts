...
bk_global.appendChild(document.createTextNode(\`
    ...
    ${!under ? "" :
    `body .split-view-view:nth-child(3) *:not([role="tooltip"], .monaco-count-badge, .badge-content, .label, .action-item *, .monaco-button, .view-overlays *, .sticky-widget *), body > div {
